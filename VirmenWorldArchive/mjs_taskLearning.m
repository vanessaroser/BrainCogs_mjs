...
function code = mjs_taskLearning
...
%                     vr.velocity(end)    = 0; %Does not affect VR but does affect output data
%                     vr.position(end)    = 0; %Try not locking theta to force adjustment before start of trial
